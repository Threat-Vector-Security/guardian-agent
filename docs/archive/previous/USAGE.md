...
On Windows, if you want the extra native isolation layer for risky subprocess-backed work, use the portable Windows build described in [INSTALLATION.md](INSTALLATION.md).
...
Current implementation details are documented in [docs/design/CODING-WORKSPACE-DESIGN.md](docs/design/CODING-WORKSPACE-DESIGN.md).
...
- [docs/security-testing-results/README.md](../../security-testing-results/README.md)
...
- Integration harness: [docs/guides/INTEGRATION-TEST-HARNESS.md](docs/guides/INTEGRATION-TEST-HARNESS.md)
- Deployment guide: [docs/guides/DEPLOYMENT.md](https://github.com/Threat-Vector-Security/guardian-agent/blob/v1.0.0/docs/guides/DEPLOYMENT.md)
