...
The executable verification scripts remain in [scripts/](../../../../../scripts) so they can be run directly. This index groups the ones used for the current security verification and the adjacent brokered/approval paths they depend on.
...
- [test-web-approvals.mjs](../../../../../scripts/test-web-approvals.mjs)
  Purpose: web approval continuation path and approval UX regression checks.

- [test-cli-approvals.mjs](../../../../../scripts/test-cli-approvals.mjs)
  Purpose: CLI approval flow regression checks.

- [test-telegram-approvals.mjs](../../../../../scripts/test-telegram-approvals.mjs)
  Purpose: Telegram approval flow regression checks.

## Supporting Brokered Runtime Harnesses

- [test-brokered-isolation.mjs](../../../../../scripts/test-brokered-isolation.mjs)
  Purpose: end-to-end brokered worker execution check through the web/API surface.

- [test-brokered-worker-smoke.mjs](../../../../../scripts/test-brokered-worker-smoke.mjs)
