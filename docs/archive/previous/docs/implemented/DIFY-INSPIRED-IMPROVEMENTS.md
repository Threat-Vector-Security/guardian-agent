...
> **Note:** This proposal has been promoted to a design/as-built document. See `docs/design/DIFY-INSPIRED-IMPROVEMENTS-DESIGN.md` (`docs/design/DIFY-INSPIRED-IMPROVEMENTS-DESIGN.md`, historical reference) for the authoritative version with implementation status.
