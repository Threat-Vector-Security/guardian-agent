...
- See ORCHESTRATION-DESIGN.md (`docs/design/ORCHESTRATION-DESIGN.md`, historical reference) for current status. The former standalone hardening design is archived at `docs/archive/design/MULTI-AGENT-WORKFLOW-HARDENING-DESIGN.md`.
