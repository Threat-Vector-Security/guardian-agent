...
**Related docs:** ORCHESTRATION-DESIGN.md (`docs/design/ORCHESTRATION-DESIGN.md`, historical reference), [AGENTIC-DEFENSIVE-SECURITY-SUITE-AS-BUILT.md](../design/AGENTIC-DEFENSIVE-SECURITY-SUITE-AS-BUILT.md), BitNet CPU decision-lane proposal direction
...
- docs/design/ORCHESTRATION-DESIGN.md (`docs/design/ORCHESTRATION-DESIGN.md`, historical reference)
- src/agent/orchestration.ts (`src/agent/orchestration.ts`, historical reference)
- src/agent/recipes.ts (`src/agent/recipes.ts`, historical reference)
- [src/index.ts](../../../../../src/index.ts)
