...
Cross-turn taint tracking is not an MVP feature. The framework should be designed to support future data labels, but the initial spec will stop at **single-decision contextual labels** only.
