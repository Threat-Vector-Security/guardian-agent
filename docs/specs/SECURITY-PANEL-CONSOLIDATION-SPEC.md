# Security Panel Consolidation Spec

**Status:** Proposed intended implementation  
**Date:** 2026-03-21  
**Owner:** Security + Web UI  
**Amends:** [WEBUI-DESIGN-SPEC.md](/mnt/s/Development/GuardianAgent/docs/specs/WEBUI-DESIGN-SPEC.md) for the `Security` page only  
**Related:** [AGENTIC-DEFENSIVE-SECURITY-SUITE-AS-BUILT-SPEC.md](/mnt/s/Development/GuardianAgent/docs/specs/AGENTIC-DEFENSIVE-SECURITY-SUITE-AS-BUILT-SPEC.md)
