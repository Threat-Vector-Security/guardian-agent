...
Historical proposal. The shipped behavior now lives in [PACKAGE-INSTALL-TRUST-SPEC.md](/mnt/s/development/guardianagent/docs/specs/PACKAGE-INSTALL-TRUST-SPEC.md).
