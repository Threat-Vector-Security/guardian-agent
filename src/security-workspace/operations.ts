...
export const OPERATIONS: Operation[] = [
  ...
  { name: 'aws.status.get', description: 'Read local AWS credential mode, pinned account/region, last identity verification and collection coverage without making AWS calls.', scope: 'cloud:read', readOnly: true, schema: object() },
  { name: 'aws.check.start', description: 'Start read-only security collection in the account and region pinned explicitly or discovered at process startup.', scope: 'cloud:collect', schema: object() },
