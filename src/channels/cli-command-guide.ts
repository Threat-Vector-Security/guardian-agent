...
export const CLI_HELP_TOPICS: readonly CliHelpTopic[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'The advanced-controls line shows whether reasoning, reasoning-summary, verbosity, or thinking controls come from live API metadata, provider metadata, a model-family rule, or a safe default.',
  ...
  },
  {
    aliases: ['reset'],
    title: '/reset',
    summary: 'Clear the current conversation state and start fresh without removing the agent itself.',
    usage: [
      '/reset [agentId]',
    ],
    notes: [
      'Use /reset to clear the current CLI conversation.',
      'Pass an agentId to target a specific agent, for example /reset default.',
