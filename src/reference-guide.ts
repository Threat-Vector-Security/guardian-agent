            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Use `/assistant jobs followup <jobId> <replay|defer|dismiss>` when a held result is waiting for operator review.',
            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Held delegated-result actions such as replay, defer, and dismiss are available from System or CLI `/assistant jobs followup`, and Guardian audits the acting surface when it is available.',
