            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Session cards now distinguish `CURRENT`, `VIEWING`, `REFERENCED`, and `TARGETED`: `CURRENT` is the mutable workspace for Guardian chat, `VIEWING` is the session the workbench is inspecting locally, `REFERENCED` is an inspect-only workspace kept in the portfolio for comparison and reasoning, and `TARGETED` is a non-primary workspace Guardian chat is explicitly pinned to for the next coding work until you clear it.',
