            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Open Configuration > Second Brain when you want to change workday hours, assistant response style, default delivery channels, or retrieval defaults later without rerunning a one-shot wizard.',
            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Configuration > Second Brain owns the editable setup preferences for workday defaults, assistant response style, delivery defaults, and retrieval posture. It is not a separate memory system.',
