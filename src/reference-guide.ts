            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Second Brain as-built design: https://github.com/Example-Org/guardian-agent/blob/main/docs/design/SECOND-BRAIN-AS-BUILT.md',
            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'In Model Auto Selection Policy choose the managed-cloud provider family Auto mode should use, such as Ollama Cloud, OpenRouter, or NVIDIA Cloud.',
