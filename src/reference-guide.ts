          ...
          },
          {
            ...
            sections: [
              ...
              },
              {
                title: 'Routines',
                items: [
                  'Routines exposes the bounded Second Brain assistant routines that support briefs, sync, horizon checks, follow-up, and topic watches.',
                  ...
                  'Guardian now ships the default assistant set configured: Morning Brief, Weekly Review, Sync Calendar and Contacts, Daily Agenda Check, Pre-Meeting Brief, and Follow-Up Draft.',
                  'Use `Create routine` to add another bounded routine type without leaving the tab. `Topic Watch` is the current modular custom routine type and supports more than one configured instance.',
