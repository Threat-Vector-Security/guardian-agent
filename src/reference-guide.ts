            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Runtime Execution filters can narrow the timeline by continuity key, active execution reference, parent run, agent, channel, code session, and run status such as running, awaiting approval, blocked, completed, or failed.',
                  'Runtime Execution can also show delegated or child runs so you can tell whether background work finished. Use the row actions to jump from a visible run to its children or back to its parent.',
