            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'System shows the active assistant lane and any specialist role labels attached to delegated work, so you can quickly tell whether Guardian is coordinating, exploring, implementing, or verifying.',
            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Generic requests for Second Brain notes, tasks, contacts, library items, briefs, routines, or local calendar work stay on the local Second Brain path even when Google Workspace or Microsoft 365 is connected.',
            ...
            sections: [
              {
                title: 'Main Links',
                items: [
                  'Repository: https://github.com/Example-Org/guardian-agent',
                  'Source code: https://github.com/Example-Org/guardian-agent/tree/main/src',
                  'README: https://github.com/Example-Org/guardian-agent/blob/main/README.md',
                  'Security policy: https://github.com/Example-Org/guardian-agent/blob/main/SECURITY.md',
                  'Second Brain as-built spec: https://github.com/Example-Org/guardian-agent/blob/main/docs/specs/SECOND-BRAIN-AS-BUILT-SPEC.md',
                  'Docs and technical notes: https://github.com/Example-Org/guardian-agent/tree/main/docs',
                  'Issues and pull requests: https://github.com/Example-Org/guardian-agent/issues',
                ],
              },
              {
            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Hover the badge when you need extra detail such as the exact model, retry notes, or whether the reply text was handled directly by product logic after routing.',
                  ...
                  'Use `Clear Pending` from `System` in the `Pending Approvals` section header when a stale approval or clarification prompt is stuck. It clears the current web chat surface pending-action state and denies any still-pending approvals tied to that web user/channel so the blocked work cannot resume later by accident.',
              ...
              },
              {
                ...
                items: [
                  ...
                  'When Guardian hands work to another agent, the live activity feed can also show which worker took the task and whether that worker is still running, blocked, or finished.',
            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Routing Trace gives you a quick explanation of how Guardian interpreted a request, where it sent the work, and when brokered worker dispatch actually started, ran, retried, completed, or failed.',
                  'Delegated-worker trace rows now also show the effective delegated intent and whether it came from preserved routed metadata or delegated-role derivation, which makes escalation decisions easier to troubleshoot.',
            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Route-confirmation answers like `Repo work`, `Workspace/session control`, `Create new automation`, or `Guardian page` should resume the original blocked request instead of being treated as separate new tasks.',
            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'Attached coding sessions keep the shared workspace context and approvals, but Auto routing still chooses the active local, managed-cloud, or frontier path for each turn unless you explicitly force a mode or provider.',
                  ...
                  '**Intelligent Sandbox Advisory:** Guardian automatically selects the best sandbox for each task by analyzing your workspace. It prioritizes Vercel for fast, stateless tasks and Daytona for complex builds or projects with native dependencies (like `node-pty` or `pandas`).',
                  '**Behavioral Equivalence:** The system performs language-agnostic fingerprinting to detect build markers (e.g., `Makefile`, `go.mod`, `Cargo.toml`) and native requirements across Python, Go, Rust, and C/C++, ensuring the correct build environment is used regardless of the programming language.',
                  '**Manual Lifecycle Control:** Persistent sandboxes feature provider-aware lifecycle controls in the Sandboxes tab. Daytona supports stopping and restarting the same managed sandbox, while Vercel keeps stopped cards visible but requires release and recreation instead of restart.',
                  '**Status Monitoring:** Managed sandboxes display the provider-reported lifecycle state, including badges such as **RUNNING**, **STOPPED**, **STARTING**, **EXPIRED**, **FAILED**, or **UNREACHABLE** so you can monitor active resource usage at a glance.',
                  'The Sandboxes tab stays provider-neutral. It can show either Vercel, Daytona, or both, and the tooltips explain the practical tradeoff: Vercel is usually the quicker fit for short bounded runs, while Daytona is stronger for reusable longer-running workspace state.',
              ...
              },
              {
                ...
                items: [
                  ...
                  'If a delegated coding request explicitly mentions a different saved coding workspace than the current attachment, Guardian automatically switches this chat to that workspace before it runs the CLI. If the target is ambiguous or cannot be matched, it stops instead of silently running in the wrong repo.',
                ],
              },
              {
            ...
            sections: [
              ...
              },
              {
                ...
                items: [
                  ...
                  'For exact repo-inspection asks, Guardian can reject a weak delegated answer that admits truncation or uncertainty, retry that delegated work once on a stronger eligible profile, and fail clearly if no stronger eligible profile exists instead of pretending the vague answer was complete.',
                  'If a delegated worker only returns a progress-style update instead of a finished result, Guardian can also retry that child run once on a stronger eligible profile before surfacing a failure.',
