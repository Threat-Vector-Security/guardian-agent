            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Use `Clear Pending` in the web chat toolbar when a stale approval or clarification prompt is stuck in the chat panel. It clears the current chat surface pending-action state and denies any still-pending approvals tied to that web user/channel so the blocked work cannot resume later by accident.',
