            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Runtime Execution filters can narrow the timeline by continuity key, active execution reference, and run status such as running, awaiting approval, blocked, completed, or failed.',
