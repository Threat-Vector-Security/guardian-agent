            ...
            sections: [
              {
                ...
                items: [
                  ...
                  'Use the web New Conversation control, CLI `/reset [agentId]`, or Telegram `/reset [agentId]` to clear context. In CLI, `/reset` clears the attached coding-session conversation when one is active; pass an agent id such as `/reset default` to clear regular chat context instead.',
