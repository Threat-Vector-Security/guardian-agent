...
const STATIC_APP_RUNTIME_CHECK_SCRIPT = [
  ...
  '  const issues = [];',
  '  assertMusicTarget(\'song list\', ids, jsSource, [\'song-list\', \'recent-songs\', \'browse-results\', \'all-songs\', \'recently-played\'], issues);',
  '  assertMusicTarget(\'playlist list\', ids, jsSource, [\'playlist-list\', \'playlist-grid\', \'sidebar-playlist-list\'], issues);',
  '  assertMusicTarget(\'artist list\', ids, jsSource, [\'artist-list\', \'artist-grid\', \'popular-artists\'], issues);',
