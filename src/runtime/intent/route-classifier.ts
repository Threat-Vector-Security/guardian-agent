...
const INTENT_GATEWAY_INSTRUCTION_LINES = [
  ...
  '- coding_session_control: managing coding workspace sessions — listing sessions, inspecting the current session, inspecting managed sandboxes attached to the current session, checking Daytona or remote sandbox status, switching/attaching, detaching, or creating sessions.',
...
const INTENT_GATEWAY_JSON_FALLBACK_SYSTEM_PROMPT = [
  ...
  'coding_session_control means current session, list sessions, switch or attach to another session, detach, create a coding session, or inspect attached managed sandbox status such as Daytona status.',
