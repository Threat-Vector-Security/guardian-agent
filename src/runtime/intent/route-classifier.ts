...
const INTENT_GATEWAY_INSTRUCTION_LINES = [
  ...
  'Example: "Inspect the Guardian workspace and tell me what files matter most." -> route=coding_task or coding_session_control, resolution=needs_clarification, missingFields=["intent_route"], summary="Do you want me to inspect or work inside the repo, or do you want me to manage the current coding workspace/session?"',
...
const INTENT_GATEWAY_COMPACT_INSTRUCTION_LINES = [
  ...
  'Example: "Inspect the Guardian workspace and tell me what files matter most." -> resolution=needs_clarification, missingFields=["intent_route"], summary="Do you want me to inspect or work inside the repo, or do you want me to manage the current coding workspace/session?"',
...
const INTENT_GATEWAY_ROUTE_ONLY_FALLBACK_SYSTEM_PROMPT = [
  ...
  'Example: "Inspect the Guardian workspace and tell me what files matter most." -> route="coding_task" or "coding_session_control", resolution="needs_clarification", summary="Do you want me to inspect or work inside the repo, or do you want me to manage the current coding workspace/session?"',
