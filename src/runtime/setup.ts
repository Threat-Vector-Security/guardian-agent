...
export interface SetupApplyInput {
  ...
  providerName?: string;
  /** Built-in provider type from the runtime registry (for example ollama/ollama_cloud/openrouter/nvidia/openai/anthropic/groq/mistral/deepseek/together/xai/google). */
  providerType?: string;
  model?: string;
  apiKey?: string;
