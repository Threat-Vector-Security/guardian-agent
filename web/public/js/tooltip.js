...
const DEFAULT_TOOLTIPS = {
  ...
  '#browser-enabled': 'Master switch for all browser automation. Disabling removes both Playwright and Lightpanda MCP tools.',
  ...
  '#browser-lightpanda-enabled': 'Enables Lightpanda MCP — a lightweight browser for fast page reading (markdown, links, structured data). Beta.',
