...
function normalizeTheme(theme) {
  ...
  const normalized = {
    ...
    vars: {
      ...
      '--layout-chat-column': vars['--layout-chat-column'] || 'clamp(480px, 29vw, 520px)',
      '--layout-chat-column-wide': vars['--layout-chat-column-wide'] || vars['--layout-chat-column'] || 'clamp(500px, 31vw, 560px)',
