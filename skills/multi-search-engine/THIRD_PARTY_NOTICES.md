...
- **Source:** ClawHub
- **Upstream Repo:** https://github.com/openclaw/skills
- **Upstream Path:** skills/gpyangyoujun/multi-search-engine/SKILL.md
- **Upstream Commit:** 7cc622d1b8d9ceeea735baf188eb4172b56b5455
- **Original Author:** gpyangyoujun
- **License:** MIT
- **Imported:** 2026-03-17
...
- Copied reviewed bundle siblings (references/templates/examples/assets/scripts) when present
